...
const GithubIcon = ({ extraSvgId, ...props }) => (
  <IconWrapper>
    <svg viewBox="0 0 40 40" {...props}>
      <defs>
        <path
          id={`prefix_github_icon__a_${extraSvgId}`}
          d="M.1.4h39.7V40H.1z"
        />
      </defs>
      <clipPath id={`prefix_github_icon__b_${extraSvgId}`}>
        <use xlinkHref="#prefix_github_icon__a" overflow="visible" />
      </clipPath>
      <g clipPath="url(#prefix_github_icon__b)">
        <defs>
          <path
            id={`prefix_github_icon__c_${extraSvgId}`}
            d="M-262.9-16.6h1440v1080h-1440z"
          />
        </defs>
        <clipPath id={`prefix_github_icon__d_${extraSvgId}`}>
          <use xlinkHref="#prefix_github_icon__c" overflow="visible" />
        </clipPath>
        <g clipPath="url(#prefix_github_icon__d)">
          <defs>
            <path
              id={`prefix_github_icon__e_${extraSvgId}`}
              d="M-.9.4h41v40h-41z"
            />
          </defs>
          <clipPath id={`prefix_github_icon__f_${extraSvgId}`}>
            <use xlinkHref="#prefix_github_icon__e" overflow="visible" />
          </clipPath>
          <g clipPath="url(#prefix_github_icon__f)">
            <defs>
              <path
                id={`prefix_github_icon__g_${extraSvgId}`}
            ...
            <clipPath id={`prefix_github_icon__h_${extraSvgId}`}>
              <use xlinkHref="#prefix_github_icon__g" overflow="visible" />
            </clipPath>
            <g clipPath="url(#prefix_github_icon__h)">
              <defs>
                <path
                  id={`prefix_github_icon__i_${extraSvgId}`}
                  d="M.1.4h40v40H.1z"
                />
              </defs>
              <clipPath id={`prefix_github_icon__j_${extraSvgId}`}>
