...
const LinkedinIcon = props => (
  <IconWrapper>
    <svg viewBox="0 0 40 40" {...props}>
      ...
      <clipPath id="prefix_linked_in__b">
        <use xlinkHref="#prefix_linked_in__a" overflow="visible" />
      </clipPath>
      <g clipPath="url(#prefix_linked_in__b)">
        <defs>
          <path id="prefix_linked_in__c" d="M-118.7-17h1440v1080h-1440z" />
        </defs>
        <clipPath id="prefix_linked_in__d">
          <use xlinkHref="#prefix_linked_in__c" overflow="visible" />
        </clipPath>
        <g clipPath="url(#prefix_linked_in__d)">
          <defs>
            <path id="prefix_linked_in__e" d="M-4.7-5h50v50h-50z" />
          </defs>
          <clipPath id="prefix_linked_in__f">
            <use xlinkHref="#prefix_linked_in__e" overflow="visible" />
          </clipPath>
          <g clipPath="url(#prefix_linked_in__f)">
            <defs>
              <path id="prefix_linked_in__g" d="M-4.7-5h49.4v50H-4.7z" />
            </defs>
            <clipPath id="prefix_linked_in__h">
              <use xlinkHref="#prefix_linked_in__g" overflow="visible" />
            </clipPath>
            <g clipPath="url(#prefix_linked_in__h)">
              <defs>
                <path id="prefix_linked_in__i" d="M.3 0h40v40H.3z" />
              </defs>
              <clipPath id="prefix_linked_in__j">
